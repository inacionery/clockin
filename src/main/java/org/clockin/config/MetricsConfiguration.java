...
public class MetricsConfiguration extends MetricsConfigurerAdapter {
    ...
    public void init() {
        ...
        if (jHipsterProperties.getMetrics().getLogs().isEnabled()) {
            ...
            reporter.start(
                jHipsterProperties.getMetrics().getLogs().getReportFrequency(),
                TimeUnit.SECONDS);
        }
    }
    ...
    public static class SparkRegistry {
        ...
        private void init() {
            if (jHipsterProperties.getMetrics().getSpark().isEnabled()) {
                ...
                String sparkHost = jHipsterProperties.getMetrics().getSpark()
                    .getHost();
                Integer sparkPort = jHipsterProperties.getMetrics().getSpark()
                    .getPort();
