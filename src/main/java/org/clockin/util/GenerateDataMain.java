...
public class GenerateDataMain {
    ...
    private static String insert = "INSERT INTO clockin.clockin (sequential_register_number, date_time, registry_type, employee_id) VALUES('0000%s', '%s:00.000000', 'TYPE_3', 1);%n";
    ...
    private static void printHours(LocalDate startDate) {
        ...
        if (startDate.getDayOfWeek().equals(DayOfWeek.WEDNESDAY)) {
            ...
            LocalDateTime b06Batida01 = startDate.atTime(B06_HORA_01)
                .plusMinutes(GENERATOR.nextInt(60));
            LocalDateTime b06Batida02 = startDate.atTime(B06_HORA_02);
            LocalDateTime b06Batida03 = startDate.atTime(B06_HORA_03)
                .plusMinutes(GENERATOR.nextInt(60));
            LocalDateTime b06Batida04 = startDate.atTime(B06_HORA_04);
            LocalDateTime b06Batida05 = startDate.atTime(B06_HORA_05);
            LocalDateTime b06Batida06 = startDate.atTime(B06_HORA_06)
                .plusMinutes(GENERATOR.nextInt(60));
            ...
            LocalDateTime b04Batida01 = startDate.atTime(B04_HORA_01)
                .plusMinutes(GENERATOR.nextInt(60));
            LocalDateTime b04Batida02 = startDate.atTime(B04_HORA_02);
            LocalDateTime b04Batida03 = startDate.atTime(B04_HORA_03)
                .plusMinutes(GENERATOR.nextInt(60));
