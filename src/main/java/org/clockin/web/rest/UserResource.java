...
public class UserResource {
    ...
    public ResponseEntity<?> createUser(
        @RequestBody ManagedUserVM managedUserVM, HttpServletRequest request)
        ...
        else if (userRepository.findOneByEmail(managedUserVM.getEmail())
            .isPresent()) {
            return ResponseEntity.badRequest()
                .headers(HeaderUtil.createFailureAlert("userManagement",
    ...
    @Timed
    @Secured(AuthoritiesConstants.ADMIN)
    public ResponseEntity<ManagedUserVM> updateUser(
        @RequestBody ManagedUserVM managedUserVM) {
        log.debug("REST request to update User : {}", managedUserVM);
        Optional<User> existingUser = userRepository
            .findOneByEmail(managedUserVM.getEmail());
        ...
        return ResponseEntity.ok()
            ...
            .body(new ManagedUserVM(
                userService.getUserWithAuthorities(managedUserVM.getId())));
    }
    ...
    public ResponseEntity<List<ManagedUserVM>> getAllUsers(Pageable pageable)
        ...
        List<ManagedUserVM> managedUserVMs = page.getContent().stream()
            .map(ManagedUserVM::new).collect(Collectors.toList());
    ...
    @Timed
    @Transactional(readOnly = true)
    public ResponseEntity<List<ManagedUserVM>> getAllUsersManager()
        throws URISyntaxException {
    ...
    public ResponseEntity<ManagedUserVM> getUser(@PathVariable String login) {
        ...
        return userService.getUserWithAuthoritiesByLogin(login)
            ...
            .map(managedUserVM -> new ResponseEntity<>(managedUserVM,
                HttpStatus.OK))
