(function() {
    ...
    ManagerController.$inject = ['Manager', 'entity', '$scope', '$state', '$locale', '$rootScope', '$stateParams'];

    function ManagerController(Manager, entity, $scope, $state, $locale, $rootScope, $stateParams) {
        var vm = this;
        ...
        vm.predicate = "employee.firstName";
        vm.reverse = true;
