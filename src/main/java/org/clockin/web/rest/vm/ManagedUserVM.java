package org.clockin.web.rest.vm;
...
public class ManagedUserVM extends UserDTO {
    ...
    public ManagedUserVM(Long id, String login, String password,
        ...
        String langKey, Set<String> authorities, String createdBy,
        ZonedDateTime createdDate, String lastModifiedBy,
    ...
    public String toString() {
        return "ManagedUserVM{" + "id=" + id + ", createdBy=" + createdBy
