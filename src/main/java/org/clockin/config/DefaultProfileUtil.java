...
public final class DefaultProfileUtil {
    ...
    private static final Logger log = LoggerFactory
        .getLogger(DefaultProfileUtil.class);
    ...
    public static String getDefaultActiveProfiles() {
        if (BUILD_PROPERTIES != null) {
            String activeProfile = BUILD_PROPERTIES
                .getProperty(SPRING_PROFILE_ACTIVE);
        ...
        log.warn(
            "No Spring profile configured, running with default profile: {}",
    ...
    private static Properties readProperties() {
        try {
            ...
            factory
                .setResources(new ClassPathResource("config/application.yml"));
